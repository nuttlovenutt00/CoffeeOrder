			...
			<div class="wrap-login100">
				<form class="login100-form validate-form " action="<?php echo base_url('Login/checklogin'); ?>" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "ชื่อผู้ใช้ ห้ามเว้นค่าว่าง">
						<input class="input100" type="text" name="username" id="username" autocomplete="off" style="font-family: 'Prompt'" >
					...
					<div class="wrap-input100 validate-input" data-validate="รหัสผ่าน ห้ามเว้นว่าง" >
						<input class="input100" type="password" name="password" id="password" style="font-family: 'Prompt'" >
						<span class="focus-input100"></span>
